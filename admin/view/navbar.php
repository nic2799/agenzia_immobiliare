    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        ?>
          ...
          <li class="nav-item ">
            <a class="nav-link " href="http://localhost:80/SWBD/esame-swbd/admin/dashboard_clienti.php">
              <i class="fa fa-users fa-xs"></i> Utenti registrati nella piattaforma</a>
          </li>
          <li  class="nav-item <?=$class?>">
            <a class="nav-link" href="http://localhost:80/SWBD/esame-swbd/admin/inserisci_immobile.php"> 
            <i class="fas fa-home fa-xs"></i> 
            Inserire Immobile</a>
            
          </li>
          <li  class="nav-item <?=$class?>">
            <a class="nav-link" href="http://localhost:80/SWBD/esame-swbd/admin/dashboard_prenotazioni.php"> 
