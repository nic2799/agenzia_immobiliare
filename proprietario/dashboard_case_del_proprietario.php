...
//require_once '../functions.php';
    ...
    <h1 class="mt-5"> Benvenuto <?=$sessionusername?>, queste sono le tue case in vendita</h1>
    <?php      
        $params = [
            'cerca' => $cerca,
       ...
       $totalusers = countUserImmobili();
        $numPages = ceil($totalusers/$recordsPerPage);
        

        
        $immobile = getUserYourHome($params);
        
        
        require_once 'view/case_del_proprietario.php';
